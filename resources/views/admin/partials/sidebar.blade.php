<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapsePost" class="collapse" aria-labelledby="headingPost" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="Post-color.html">Colors</a>
                <a class="collapse-item" href="Post-border.html">Borders</a>
                <a class="collapse-item" href="Post-animation.html">Animations</a>
                <a class="collapse-item" href="Post-other.html">Other</a>
            </div>
        </div>
    </li>
